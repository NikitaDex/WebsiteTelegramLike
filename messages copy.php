                    ...
                    <div class="users-list">
                        <div class="flex-container">
                            ...
                            // else isset findBtn
                                ...
                                $queryFind = "SELECT login FROM users WHERE (login='$findString' or 
                                first_name='$findString' or last_name='$findString' or date LIKE '%$findString%') and login != 'root' ";
                                $result = mysqli_query($link,$queryFind);

                                $query_image = "SELECT login,image FROM images WHERE login != '$login' and login != 'root'";
                                ...
                                while($row = mysqli_fetch_assoc($result) ){
                                    ...
                                    echo "row = ".$row['login'];
                                    echo "<br>";
                                    echo "row_image = ".$row_image['login'];
                                    // TODO REMOVE
                                    if(isset($_POST["onClickBtn-$row[login]"])){
                                        $_SESSION['choosen_image'] = $display_image; 
                                        $_SESSION['choosen'] = $row['login'];        
