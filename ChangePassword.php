...
<html lang="en">
  ...
  <?php
      ...
      if(isset($_SESSION['id'])){
          ...
          } else { $new_pass_dont_eq = "Новые пароли не совпадают !"; }
          
          } else if (isset($_POST['old_password'])){ 
              $old_pass_uncorrect = "Старый пароль введён неверно !"; 
          }
      }

  ?>
    <div class="header">
      <div class="header__title"><h1><a href="PesonalArea.php" class="material-icons-outlined place">arrow_back_ios_new</a>Изменить пароль</h1></div>
    </div>
    <div class="main">
      ...
      <?php if(isset($new_pass_dont_eq) or isset($old_pass_uncorrect) )
        ...
        <?php
          ...
          if(isset($old_pass_uncorrect))
            echo $old_pass_uncorrect;     
          ?>
        <?php if(isset($new_pass_dont_eq) or isset($old_pass_uncorrect) )
        echo "</div>"?>
    </div>
