...
<html lang="en">
  ...
  <?php
      ...
      if(isset($_SESSION['id'])){
        ...
        mid_name ='$mid_name', date = '$date', login = '$login' WHERE id='$id'";
    ...
    <div class="container">
      <div class="header">
        <div class="header__title"><h1><a href="PesonalArea.php" class="material-icons-outlined place">arrow_back_ios_new</a>Личный кабинет</h1></div>
      </div>
